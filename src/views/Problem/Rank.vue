  ...
  <div>
    <el-main id="main">
      ...
      <el-table :data="tableData" style="width: 100%">
        <!--          max-height="250">-->
        <el-table-column fixed prop="pid" label="题号" width="150">
        </el-table-column>
        <el-table-column prop="sname" label="类型" width="150">
        </el-table-column>
        <el-table-column prop="title" label="题目" width="150">
        </el-table-column>
        <el-table-column prop="status" label="通过" width="150">
        </el-table-column>
        <!-- <el-table-column fixed="right" label="操作(并没用)" width="120">
