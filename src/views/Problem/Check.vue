    ...
    <div class="block" style="margin-top: 5%">
      <el-timeline>
        <el-timeline-item  placement="top" v-for="check in checks">
          ...
          <el-button type="success" icon="el-icon-check" circle @click="right(check.id,check.pid)"></el-button>
          <el-button type="danger" icon="el-icon-close" circle @click="failure(check.id,check.pid)"></el-button>
        </el-timeline-item>
      </el-timeline>
