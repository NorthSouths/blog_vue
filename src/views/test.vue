<template>
  <el-container class="containter">
    <el-aside class="aside" width="200px" style="background-color: white;">
      <el-menu
        router
        :default-active="$route.path"
        :default-openeds="['/test/blogs']"
      >
        <br /><br />
        <img src="../assets/logo.png" style="width: 50%;margin-left: 20%" />
        <div style="margin-top: 2%;margin-left: 50px;font-size: 20px">
          {{ user.username }}
        </div>
        <!-- <a-tag
          style="font-size: 18px;border: none;margin-top: 15px;margin-left: 5%"
          >{{ this.nowDate }}</a-tag
        > -->
        <el-menu-item
          index="/test/blogs"
        ...
        <el-menu-item
          ...
          v-show="!hasLogin"
          style="margin-left: 10%"
          ><i class="el-icon-s-order"></i>登录页面</el-menu-item
        >
        <el-menu-item
          index="/test/blog/add"
          v-show="hasLogin"
        ...
        <el-menu-item
          ...
          v-show="hasLogin"
          style="margin-left: 10%"
          ><i class="el-icon-edit"></i>查看题库</el-menu-item
        >
        <el-menu-item
          index="/test/make"
          v-show="status"
          style="margin-left: 10%"
          ><i class="el-icon-s-ticket"></i>发布题目</el-menu-item
        >
        <el-menu-item
          index="/test/check"
          v-show="status"
          style="margin-left: 10%"
          ><i class="el-icon-s-management"></i>检查提交</el-menu-item
        >
        <el-menu-item
          index="/test/rank"
          v-show="hasLogin"
        ...
        <el-menu-item
          v-show="hasLogin"
          @click="logout"
          style="margin-left: 10%;color: crimson"
